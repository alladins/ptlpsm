  ...
  <div class="system-config">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
      ...
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">최대 파일 크기 (MB)</label>
            <input
              type="number"
              value="10"
              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div class="flex justify-end space-x-3 pt-6 border-t">
          <button class="px-4 py-2 bg-gray-500 text-white rounded-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500">
            초기화
          </button>
