...
| # | 페이지 | 상태 | 완료일 | API 스펙 | 비고 |
|---|--------|------|--------|----------|------|
| 1 | 출하 등록 | 🔵 계획 | - | - | 우선순위 4위 |
| 2 | 출하 수정 | ✅ 완료 | 2025-01-25 | [링크](./API_SPEC_SHIPMENT_DETAIL_WITH_ORDER.md) | API 통합 완료 (3개→1개) |
| 3 | 운송 등록 | 🟡 진행중 | - | 작성 필요 | 우선순위 1위 |
| 4 | 운송 수정 | 🔵 계획 | - | - | 우선순위 2위 |
| 5 | 발주 상세 | 🚫 불필요 | - | - | 최적화 불필요 |
| 6 | 발주 수정 | 🔵 계획 | - | - | 우선순위 3위 |
...
### 범례
- ✅ 완료: 프론트엔드 + 백엔드 API 모두 완료
- 🟡 진행중: 분석 완료, API 스펙 작성 중
- 🔵 계획: 분석 완료, 작업 대기
- 🚫 불필요: 리팩토링 불필요
